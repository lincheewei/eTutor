...
<!DOCTYPE html>
<html>
    <?php Utility::loadHeader("Reallocation", array("bootstrap.min.css")); ?>
        ...
        <main class="container">
            <div class="row pt-4">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <h4 class="text-center">Reallocation</h4>
                    <hr />
                </div>
                ...
                <div class="col-md-3 col-xs-12 col-sm-12">
                    <div class="card sticky-top">
                        <div class="card-body">
                            ...
                            <button type="submit" id="submit" value="Submit" form="form" class="btn btn-success btn-block">Submit</button>
                        </div>
                    </div>
                </div>
            </div>
